	...
	grunt.initConfig({
		...
		uglify: {
			dist: {
				...
				files: {
					'dist/<%= cfg.filename %>.min.js': ['www/<%= cfg.filename %>.js'],
					'dist/jquery.<%= cfg.filename %>.min.js': ['www/jquery.<%= cfg.filename %>.js'],
					'dist/angular.<%= cfg.filename %>.min.js': ['www/angular.<%= cfg.filename %>.js']
				}
			}
		},
